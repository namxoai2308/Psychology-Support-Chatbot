...
class Settings(BaseSettings):
    ...
    GROQ_API_KEY_11: Optional[str] = None
    GROQ_API_KEY_12: Optional[str] = None
    GROQ_API_KEY_13: Optional[str] = None
    GROQ_API_KEY_14: Optional[str] = None
    GROQ_API_KEY_15: Optional[str] = None
